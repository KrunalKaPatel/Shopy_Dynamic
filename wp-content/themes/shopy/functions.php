...
if ( ! function_exists( 'shopy_setup' ) ) :
	/**
...
function shopy_scripts() {
	...
	// wp_style_add_data( 'shopy-style', 'rtl', 'replace' );


	/*css*/
	wp_enqueue_style( 'font-awesome-css', get_template_directory_uri() . '/assets/css/font-awesome.min.css', array(), _S_VERSION);
	wp_enqueue_style( 'font-css', get_template_directory_uri() . '/assets/css/fonts.css', array(), _S_VERSION);
	...
	//wp_enqueue_style( 'w3css-css', get_template_directory_uri() . '/assets/css/w3.css', array(), _S_VERSION);

	/*js*/
	wp_enqueue_script( 'jquery-min-js', get_template_directory_uri().'/assets/js/jquery.min.js', array(), array(),true);
	wp_enqueue_script( 'main-js', get_template_directory_uri().'/assets/js/main.js', array(), array(),true);
	wp_enqueue_script( 'slick-min-js', get_template_directory_uri().'/assets/js/slick.min.js', array(), array(),true);
...
/*
	get product image on checkout page
*/
...
/*
	add wishlist option on myaccount page in sidebar
*/
